<form method="post" action="{{ route('simpan_ubah_portofolio', $data_artikel->id) }}" class="form-horizontal">
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" placeholder="Masukkan Nama Kategori" class="form-control" name="judul" value="{{$data_artikel->judul}}" id="judul" required="">
            </div>
        </div>  
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <textarea style="font-weight: bold; font-family: Arial;" name="deskripsi" id="deskripsi" value="{{$data_artikel->deskripsi}}" rows="4"class="form-control summernote">{{$data_artikel->deskripsi}}</textarea>
            </div>
        </div>     
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" placeholder="Masukkan Nama Klien" class="form-control" value="{{$data_artikel->klien}}" name="klien" id="klien" required="">
            </div>
        </div>   
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" placeholder="http://www.iam-arsip.co.id/" class="form-control" value="{{$data_artikel->link_klien}}" name="link_klien" id="link_klien" required="">
            </div>
        </div>  
