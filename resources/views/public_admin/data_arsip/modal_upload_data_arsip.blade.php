            ...
            <form method="post" id="upload_form" enctype="multipart/form-data">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label style="text-align: right;" class="col-lg-3 control-label">Judul Foto:</label>
                        <div class="col-lg-9">
                             <input type="text" class="form-control" name="judul_foto" value="">
                        </div>
                    </div>

                    <div class="form-group">
                        <label style="text-align: right;" class="col-lg-3 control-label">Deskripsi Foto:</label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            ...
                            <img id="loading" src="{{asset('global_assets/images/loading.gif')}}" style="display:none;">
            ...
            <div class="form-group"><br>
                <div class="col-lg-12" id="listupload{{$id}}">
                    <script type="text/javascript">
                        modal_upload_artikel_isi('{{csrf_token()}}', '{{$id}}', '#listupload{{$id}}');
                    </script>
                </div>
            </div>
        </div> 
...
<script>
    $(document).ready(function () {
        $('#upload_form').on('submit', function (event) {
            ...
            $.ajax({
                url: "{{ route('artikel_upload.action') }}",
                method: "POST",
