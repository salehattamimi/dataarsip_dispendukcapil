 <form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{ route('simpan_ubah_data_arsip_inactive', $data_arsip_inactive->id) }}">
<div class="row">
    ...
    <div class="col-lg-6">
            ...
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group"> 
                            <input type="number"  class="form-control" id="kode_klasifikasi" name="kode_klasifikasi" value="{{$data_arsip_inactive->kode_klasifikasi}}" min=0 placeholder="Nomor Klasifikasi">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-9">
                        <div class="input-group col-md-5">
                            <select class="form-control select2" name="data_indeks" id="data_indeks" required="" style="width: 100%"> 
                                ...
                                @if($r->id == $data_arsip_inactive->index_id)
                                <option selected="" value="{{$r->id}}">{{$r->nama_indeks}}</option>  
                                @else 
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group">
                            ...
                            value="{{$data_arsip_inactive->nama_arsip}}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-9">
                        <div class="input-group col-md-8">
                            <select class="form-control select2" name="data_kondisi" id="data_kondisi" required="" style="width: 100%"> 
                                ...
                                @if($r->id == $data_arsip_inactive->arsip_kondisi_id)
                                <option selected="" value="{{$r->id}}">{{$r->nama_kondisi}}</option>  
                                @else
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group">
                            ...
                            value="{{$data_arsip_inactive->uraian_masalah}}" 
                            >
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-9">
                        <div class="input-group col-md-8">
                            <select class="form-control select2" name="data_kategori" id="data_kategori" required="" style="width: 100%"> 
                                ...
                                @if($r->id == $data_arsip_inactive->arsip_kategori_id)
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group">
                            ...
                            value="{{$data_arsip_inactive->tahun_aktif}}" 
                            >
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group">
                            ...
                            value="{{$data_arsip_inactive->tahun_inaktif}}" 
                            >
                        </div>
                    </div>
                </div>
                <div class="form-group surat_masuk">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group">
                            <input type="number" min="0" required="" class="form-control" name="jangka_simpan" id="jangka_simpan" placeholder="Jangka Simpan" value="{{$data_arsip_inactive->jangka_simpan}}" 
                            >
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group surat_masuk">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group">
                            ...
                            value="{{$data_arsip_inactive->tingkat_perkembangan}}" 
                            >
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-9">
                        <div class="input-group col-md-8">
                            <textarea style="resize: none" class="form-control" name="keterangan" placeholder="Keterangan" id="keterangan"> 
                                {{$data_arsip_inactive->keterangan}}
                            </textarea>
                        </div>
                    </div>
                </div>
        ...
        <form class="form-horizontal" enctype="multipart/form-data" action="#">
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group col-md-8">
                            <input type="text" class="form-control" id="nomor_sementara" name="nomor_sementara" value="{{$data_arsip_inactive->nomor_sementara}}" placeholder="nomor_sementara">
                        </div>
                    </div>
                </div>  
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group col-md-8">
                            <input type="text"  class="form-control" id="nomor_berkas" value="{{$data_arsip_inactive->nomor_berkas}}" name="nomor_berkas" placeholder="Nomor Berkas">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group">
                            <input type="text"class="form-control" id="nomor_box" value="{{$data_arsip_inactive->nomor_box}}" name="nomor_box" placeholder="Nomor Box" >
                        </div>
                    </div> 
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group">
                            <input type="text" value="{{$data_arsip_inactive->nomor_rak}}" name ="nomor_rak" class="form-control" id="nomor_rak" placeholder="Nomor Rak" >
                        </div>
                    </div> 
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group col-md-8">
                            <input type="number" class="form-control" value="{{$data_arsip_inactive->nomor_bku}}" id="nomor_bku" name="nomor_bku" placeholder="Nomor BKU">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group col-md-8">
                            <input type="number" class="form-control" value="{{$data_arsip_inactive->tahun_arsip}}" id="tahun_arsip" name="tahun_arsip" placeholder="Tahun Arsip">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group col-md-8">
                            <input type="number" class="form-control" value="{{$data_arsip_inactive->bulan_arsip}}" id="bulan_arsip" name="bulan_arsip" placeholder="Bulan Arsip">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-9">
                        <div class="input-group col-md-8">
                            <select class="form-control select2" name="data_lokasi" id="data_lokasi" required="" style="width: 100%">  
                                ...
                                @if($data_arsip_inactive['arsip_lokasi_id'] == $r['id'])  
                                <option value="{{$r['id']}}" selected="">{{$r['nama_lokasi']}}</option>  
                                @else
                ...
                <div class="form-group surat_masuk">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group">
                            <input type="text" required="" class="form-control" name="nasib_akhir" value="{{$data_arsip_inactive->nasib_akhir}}" id="nasib_akhir" placeholder="Nasib Akhir">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group">
                            <input type="number"  class="form-control" id="jumlah_unit"  name="jumlah_unit" placeholder="Jumlah Unit"value="{{$data_arsip_inactive->jumlah_unit}}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-9">
                        <div class="input-group col-md-8">
                            <select class="form-control select2" name="data_pemilik" id="data_pemilik" required="" style="width: 100%"> 
                                ...
                                @if($r->id == $data_arsip_inactive->arsip_pemilik_id)
                                <option selected="" value="{{$r->id}}">{{$r->nama_pemilik}}</option>  
                                @else
