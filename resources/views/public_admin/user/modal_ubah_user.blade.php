        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_verifikasi"> 
                    <form id="formTambahMasterRS" method="post" action="{{ route('simpan_user_ubah', $data_user->id) }}" class="form-horizontal" enctype="multipart/form-data" >
                        <div class="modal-body">
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    <input required="required" type="text" value="{{$data_user->name}}" class="form-control" value="" name="nama" id="nama" >  
                                </div>
                            </div>
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    <input required="required" value="{{$data_user->username}}" type="text" class="form-control" value="" name="username" id="username" >  
                                </div>
                            </div> 
                            <div class="form-group status_lengkap" style="display:none;">
                                ...
                                <div class="col-lg-8"> 
                                    <input required="required" value="{{$data_user->password}}" type="password" class="form-control" value="" name="password" id="password" >  
                                </div>
                            </div> 
                            <div class="form-group status_lengkap" style="display:none;">
                                ...
                                <div class="col-lg-8"> 
                                    <input required="required" value="{{$data_user->password}}" type="password" class="form-control" value="" name="re_password" id="re_password" >  
                                </div>
                            </div> 
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    <input required="required" value="{{$data_user->email}}" type="email" class="form-control" value="" name="email" id="email" >  
                                </div>
                            </div>
                            <div class="form-group status_lengkap">
                                <label for="email" style="text-align: right;" class="col-lg-3 control-label">
